...
export default function () {
  ...
  var CONNECT_SERVER_STATUS_MAP_ERROR_INFO =
    ((_CONNECT_SERVER_STATU = {}),
    (_CONNECT_SERVER_STATU[CONNECT_SERVER_STATUS.IDENTIFIER_REJECTED] = ERROR_INFO.CONN_APPKEY_FAKE),
    (_CONNECT_SERVER_STATU[CONNECT_SERVER_STATUS.CONN_MINI_SERVICE_NOT_OPEN] = ERROR_INFO.CONN_MINI_SERVICE_NOT_OPEN),
    (_CONNECT_SERVER_STATU[CONNECT_SERVER_STATUS.TOKEN_INCORRECT] = ERROR_INFO.CONN_TOKEN_INCORRECT),
    (_CONNECT_SERVER_STATU[CONNECT_SERVER_STATUS.NOT_AUTHORIZED] = ERROR_INFO.CONN_NOT_AUTHRORIZED),
    (_CONNECT_SERVER_STATU[CONNECT_SERVER_STATUS.REDIRECT] = ERROR_INFO.CONN_REDIRECTED),
    (_CONNECT_SERVER_STATU[CONNECT_SERVER_STATUS.APP_BLOCK_OR_DELETE] = ERROR_INFO.CONN_APP_BLOCKED_OR_DELETED),
    (_CONNECT_SERVER_STATU[CONNECT_SERVER_STATUS.BLOCK] = ERROR_INFO.CONN_USER_BLOCKED),
    (_CONNECT_SERVER_STATU[CONNECT_SERVER_STATUS.TOKEN_EXPIRE] = ERROR_INFO.CONN_TOKEN_INCORRECT),
    (_CONNECT_SERVER_STATU[CONNECT_SERVER_STATUS.DOMAIN_INCORRECT] = ERROR_INFO.CONN_DOMAIN_INCORRECT),
    _CONNECT_SERVER_STATU)
  ...
  var SERVER_DISCONNECT_STATUS_TO_TRANSPORTER_STATUS =
    ((_SERVER_DISCONNECT_ST = {}),
    (_SERVER_DISCONNECT_ST[SERVER_DISCONNECT_STATUS.KICKED_OFFLINE_BY_OTHER_CLIENT] = TRANSPORTER_STATUS.KICKED_OFFLINE_BY_OTHER_CLIENT),
    (_SERVER_DISCONNECT_ST[SERVER_DISCONNECT_STATUS.BLOCKED] = TRANSPORTER_STATUS.BLOCKED),
    _SERVER_DISCONNECT_ST)
  var TRANSPORTER_STATUS_NEED_UPDATE_CMP = [
    TRANSPORTER_STATUS.CLOSE_NORMAL,
    TRANSPORTER_STATUS.CLOSE_GOING_AWAY,
    TRANSPORTER_STATUS.CLOSE_PROTOCOL_ERROR,
    TRANSPORTER_STATUS.CLOSE_UNSUPPORTED,
    TRANSPORTER_STATUS.UNSUPPORTED_DATA,
    TRANSPORTER_STATUS.POLICY_VIOLATION,
    TRANSPORTER_STATUS.MISSING_EXTENSION,
    TRANSPORTER_STATUS.INTERNAL_ERROR,
    TRANSPORTER_STATUS.SERVICE_RESTART,
    TRANSPORTER_STATUS.TRY_AGAIN_LATER,
    TRANSPORTER_STATUS.TSL_HANDSHAKE,
    TRANSPORTER_STATUS.PING_FIRST_TIMEOUT,
    TRANSPORTER_STATUS.DISCONNECT_TOO_FAST,
    TRANSPORTER_STATUS.COMET_REQUEST_ERROR
  ]
  var TRANSPORTER_STATUS_NEED_RECONNECT = TRANSPORTER_STATUS_NEED_UPDATE_CMP.concat([
    TRANSPORTER_STATUS.PING_TIMEOUT,
    TRANSPORTER_STATUS.CLOSE_ABNORMAL,
    TRANSPORTER_STATUS.EXCEED_MESSAGE_ID_LIMIT,
    TRANSPORTER_STATUS.COMET_REQUEST_ERROR
  ])
  var TRANSPORTER_STATUS_TO_CONNECTION_STATUS =
    ((_TRANSPORTER_STATUS_T = {}),
    (_TRANSPORTER_STATUS_T[TRANSPORTER_STATUS.CLOSE_GOING_AWAY] = CONNECTION_STATUS.SOCKET_ERROR),
    (_TRANSPORTER_STATUS_T[TRANSPORTER_STATUS.CLOSE_PROTOCOL_ERROR] = CONNECTION_STATUS.SOCKET_ERROR),
    (_TRANSPORTER_STATUS_T[TRANSPORTER_STATUS.CLOSE_UNSUPPORTED] = CONNECTION_STATUS.SOCKET_ERROR),
    (_TRANSPORTER_STATUS_T[TRANSPORTER_STATUS.CLOSE_NO_STATUS] = CONNECTION_STATUS.DISCONNECTED),
    (_TRANSPORTER_STATUS_T[TRANSPORTER_STATUS.CLOSE_ABNORMAL] = CONNECTION_STATUS.NETWORK_UNAVAILABLE),
    (_TRANSPORTER_STATUS_T[TRANSPORTER_STATUS.DISCONNECT_TOO_FAST] = CONNECTION_STATUS.NETWORK_UNAVAILABLE),
    (_TRANSPORTER_STATUS_T[TRANSPORTER_STATUS.UNSUPPORTED_DATA] = CONNECTION_STATUS.SOCKET_ERROR),
    (_TRANSPORTER_STATUS_T[TRANSPORTER_STATUS.POLICY_VIOLATION] = CONNECTION_STATUS.SOCKET_ERROR),
    (_TRANSPORTER_STATUS_T[TRANSPORTER_STATUS.CLOSE_TOO_LARGE] = CONNECTION_STATUS.SOCKET_ERROR),
    (_TRANSPORTER_STATUS_T[TRANSPORTER_STATUS.MISSING_EXTENSION] = CONNECTION_STATUS.SOCKET_ERROR),
    (_TRANSPORTER_STATUS_T[TRANSPORTER_STATUS.INTERNAL_ERROR] = CONNECTION_STATUS.SOCKET_ERROR),
    (_TRANSPORTER_STATUS_T[TRANSPORTER_STATUS.SERVICE_RESTART] = CONNECTION_STATUS.SOCKET_ERROR),
    (_TRANSPORTER_STATUS_T[TRANSPORTER_STATUS.TRY_AGAIN_LATER] = CONNECTION_STATUS.SOCKET_ERROR),
    (_TRANSPORTER_STATUS_T[TRANSPORTER_STATUS.TSL_HANDSHAKE] = CONNECTION_STATUS.SOCKET_ERROR),
    (_TRANSPORTER_STATUS_T[TRANSPORTER_STATUS.PING_FIRST_TIMEOUT] = CONNECTION_STATUS.NETWORK_UNAVAILABLE),
    (_TRANSPORTER_STATUS_T[TRANSPORTER_STATUS.PING_TIMEOUT] = CONNECTION_STATUS.NETWORK_UNAVAILABLE),
    (_TRANSPORTER_STATUS_T[TRANSPORTER_STATUS.COMET_REQUEST_ERROR] = CONNECTION_STATUS.NETWORK_UNAVAILABLE),
    _TRANSPORTER_STATUS_T)
  ...
  var COMET_REQ_HAS_TOPIC_URL_TPL =
    '{protocol}//{domain}/websocket?messageid={messageId}&header={headerCode}&sessionid={sessionId}&topic={topic}&targetid={targetId}&pid={pid}'
  ...
  var JSON$1 = {
    ...
    quote: function quote(string) {
      ...
      return self.rx_escapable.test(string)
        ? '"' +
            string.replace(self.rx_escapable, function (a) {
              var c = self.meta[a]
  ...
  var WebSession = (function () {
    ...
    _proto.set = function set(key, value) {
      global$4.sessionStorage.setItem(
        key,
        JSON$1.stringify({
          d: value
        })
  ...
  var SparePromise = (function () {
    ...
    function j() {
      var a, b, c
      for (a = 0; N > a; a += 2) (b = W[a]), (c = W[a + 1]), b(c), (W[a] = void 0), (W[a + 1] = void 0)
      N = 0
    }
    function k() {
      try {
        var a = Function('return this')().require('vertx')
        return (O = a.runOnLoop || a.runOnContext), f()
      } catch (b) {
        return i()
      }
    }
    ...
    function m(a) {
      var c,
        b = this
      return a && 'object' == typeof a && a.constructor === b ? a : ((c = new b(n)), u(c, a), c)
    }
    function n() {}
    function o() {
    ...
    function t(a, c, d) {
      c.constructor === a.constructor && d === l && c.constructor.resolve === m ? s(a, c) : void 0 === d ? w(a, c) : b(d) ? r(a, c, d) : w(a, c)
    }
    function u(b, c) {
      if (b === c) x(b, o())
      else if (a(c)) {
    ...
    function w(a, b) {
      a._state === Z && ((a._result = b), (a._state = $), 0 !== a._subscribers.length && Q(z, a))
    }
    function x(a, b) {
      a._state === Z && ((a._state = _), (a._result = b), Q(v, a))
    }
    function y(a, b, c, d) {
      var e = a._subscribers,
        f = e.length
      ;(a._onerror = null), (e[f] = b), (e[f + $] = c), (e[f + _] = d), 0 === f && a._state && Q(z, a)
    }
    function z(a) {
      var d,
        e,
        ...
        c = a._state
      if (0 !== b.length) {
        for (d = void 0, e = void 0, f = a._result, g = 0; g < b.length; g += 3) (d = b[g]), (e = b[g + c]), d ? A(c, d, e, f) : e(f)
    ...
    function A(a, c, d, e) {
      ...
      if (f) {
        ...
        if (c === g) return void x(c, p())
      } else g = e
      c._state !== Z || (f && i ? u(c, g) : i === !1 ? x(c, h) : a === $ ? w(c, g) : a === _ && x(c, g))
    }
    function B(a, b) {
      try {
        b(
    ...
    function D(a) {
      ;(a[Y] = ab++), (a._state = void 0), (a._result = void 0), (a._subscribers = [])
    }
    function E() {
      return new Error('Array Methods must be provided an Array')
    }
    function F(a) {
      return new bb(this, a).promise
    }
    function G(a) {
      var b = this
      return new b(
    ...
    return (
      ...
      (P = void 0),
      (Q = function (a, b) {
        ;(W[N] = a), (W[N + 1] = b), (N += 2), 2 === N && (P ? P(j) : X())
      }),
      (R = 'undefined' != typeof window ? window : void 0),
      (S = R || {}),
      (T = S.MutationObserver || S.WebKitMutationObserver),
      ...
      (W = new Array(1e3)),
      (X = void 0),
      (X = U ? e() : T ? g() : V ? h() : void 0 === R && 'function' == typeof require ? k() : i()),
            ...
            M(b)
              ? ((this.length = b.length),
                ...
                0 === this.length
                  ...
                  : ((this.length = this.length || 0), this._enumerate(b), 0 === this._remaining && w(this.promise, this._result)))
              : x(this.promise, E())
        }
        return (
          (a.prototype._enumerate = function (a) {
            for (var b = 0; this._state === Z && b < a.length; b++) this._eachEntry(a[b], b)
          }),
          (a.prototype._eachEntry = function (a, b) {
            ...
            if (d === m) {
              ...
              e === l && a._state !== Z
                ...
                : c === cb
                ? ((i = new c(n)), g ? x(i, f) : t(i, a, e), this._willSettleAt(i, b))
                : this._willSettleAt(
                    new c(function (b) {
                      return b(a)
                    }),
          ...
          (a.prototype._settledAt = function (a, b, c) {
            var d = this.promise
            d._state === Z && (this._remaining--, a === _ ? x(d, c) : (this._result[b] = c)), 0 === this._remaining && w(d, this._result)
          }),
      ...
      (cb = (function () {
        function a(b) {
          ;(this[Y] = C()),
            ...
            (this._subscribers = []),
            n !== b && ('function' != typeof b && I(), this instanceof a ? B(this, b) : J())
        }
        return (
  ...
  var md5 = (function () {
    ...
    function h(b, c) {
      ...
      for (
        b[c >> 5] |= 128 << c % 32, b[(((c + 64) >>> 9) << 4) + 14] = c, m = 1732584193, n = -271733879, o = -1732584194, p = 271733878, h = 0;
        h < b.length;
        h += 16
      )
        (i = m),
    ...
    function i(a) {
      var b,
        c = '',
        d = 32 * a.length
      for (b = 0; d > b; b += 8) c += String.fromCharCode(255 & (a[b >> 5] >>> b % 32))
      return c
    }
    function j(a) {
      var b,
      ...
      for (d = 8 * a.length, b = 0; d > b; b += 8) c[b >> 5] |= (255 & a.charCodeAt(b / 8)) << b % 32
      return c
    }
    function k(a) {
    ...
    function l(a, b) {
      var c,
        ...
        e = [],
        f = []
      for (e[15] = f[15] = void 0, d.length > 16 && (d = h(d, 8 * a.length)), c = 0; 16 > c; c += 1) (e[c] = 909522486 ^ d[c]), (f[c] = 1549556828 ^ d[c])
      return (g = h(e.concat(j(b)), 512 + 8 * b.length)), i(h(f.concat(g), 640))
    }
    function m(a) {
      var d,
        e,
  ...
  var Timer = (function () {
    ...
    _proto.start = function start(event, options) {
      ...
      self.stop()
      self._timerId = self._timerEvent.call(
        global$8,
        function () {
          isTimeout && self.stop()
  ...
  var PUBLISH_TOPIC_TO_CONVERSATION_TYPE =
    ((_PUBLISH_TOPIC_TO_CON = {}),
    (_PUBLISH_TOPIC_TO_CON[PUBLISH_TOPIC.PRIVATE] = CONVERSATION_TYPE.PRIVATE),
    (_PUBLISH_TOPIC_TO_CON[PUBLISH_TOPIC.GROUP] = CONVERSATION_TYPE.GROUP),
    (_PUBLISH_TOPIC_TO_CON[PUBLISH_TOPIC.CHATROOM] = CONVERSATION_TYPE.CHATROOM),
    (_PUBLISH_TOPIC_TO_CON[PUBLISH_TOPIC.CUSTOMER_SERVICE] = CONVERSATION_TYPE.CUSTOMER_SERVICE),
    (_PUBLISH_TOPIC_TO_CON[PUBLISH_STATUS_TOPIC.PRIVATE] = CONVERSATION_TYPE.PRIVATE),
    (_PUBLISH_TOPIC_TO_CON[PUBLISH_STATUS_TOPIC.GROUP] = CONVERSATION_TYPE.GROUP),
    (_PUBLISH_TOPIC_TO_CON[PUBLISH_STATUS_TOPIC.CHATROOM] = CONVERSATION_TYPE.CHATROOM),
    _PUBLISH_TOPIC_TO_CON)
  var CONVERSATION_TYPE_TO_PUBLISH_TOPIC =
    ((_CONVERSATION_TYPE_TO = {}),
    (_CONVERSATION_TYPE_TO[CONVERSATION_TYPE.PRIVATE] = PUBLISH_TOPIC.PRIVATE),
    (_CONVERSATION_TYPE_TO[CONVERSATION_TYPE.GROUP] = PUBLISH_TOPIC.GROUP),
    (_CONVERSATION_TYPE_TO[CONVERSATION_TYPE.CHATROOM] = PUBLISH_TOPIC.CHATROOM),
    (_CONVERSATION_TYPE_TO[CONVERSATION_TYPE.CUSTOMER_SERVICE] = PUBLISH_TOPIC.CUSTOMER_SERVICE),
    _CONVERSATION_TYPE_TO)
  var CONVERSATION_TYPE_TO_PUBLISH_STATUS_TOPIC =
    ((_CONVERSATION_TYPE_TO2 = {}),
    (_CONVERSATION_TYPE_TO2[CONVERSATION_TYPE.PRIVATE] = PUBLISH_STATUS_TOPIC.PRIVATE),
    (_CONVERSATION_TYPE_TO2[CONVERSATION_TYPE.GROUP] = PUBLISH_STATUS_TOPIC.GROUP),
    _CONVERSATION_TYPE_TO2)
  var CONVERSATION_TYPE_TO_QUERY_HISTORY_TOPIC =
    ((_CONVERSATION_TYPE_TO3 = {}),
    (_CONVERSATION_TYPE_TO3[CONVERSATION_TYPE.PRIVATE] = QUERY_HISTORY_TOPIC.PRIVATE),
    (_CONVERSATION_TYPE_TO3[CONVERSATION_TYPE.GROUP] = QUERY_HISTORY_TOPIC.GROUP),
    (_CONVERSATION_TYPE_TO3[CONVERSATION_TYPE.CHATROOM] = QUERY_HISTORY_TOPIC.CHATROOM),
    (_CONVERSATION_TYPE_TO3[CONVERSATION_TYPE.CUSTOMER_SERVICE] = QUERY_HISTORY_TOPIC.CUSTOMER_SERVICE),
    (_CONVERSATION_TYPE_TO3[CONVERSATION_TYPE.SYSTEM] = QUERY_HISTORY_TOPIC.SYSTEM),
    _CONVERSATION_TYPE_TO3)
  var CONVERSATION_TYPE_TO_CLEAR_MESSAGE_TOPIC =
    ((_CONVERSATION_TYPE_TO4 = {}),
    (_CONVERSATION_TYPE_TO4[CONVERSATION_TYPE.PRIVATE] = QUERY_TOPIC.CLEAR_MESSAGES.PRIVATE),
    (_CONVERSATION_TYPE_TO4[CONVERSATION_TYPE.GROUP] = QUERY_TOPIC.CLEAR_MESSAGES.GROUP),
    (_CONVERSATION_TYPE_TO4[CONVERSATION_TYPE.CUSTOMER_SERVICE] = QUERY_TOPIC.CLEAR_MESSAGES.CUSTOMER_SERVICE),
    (_CONVERSATION_TYPE_TO4[CONVERSATION_TYPE.SYSTEM] = QUERY_TOPIC.CLEAR_MESSAGES.SYSTEM),
    _CONVERSATION_TYPE_TO4)
  ...
  var ENGINE_EVENT_NEED_CONNECTED = [
    ENGINE_EVENT.GET_CONVERSATION_LIST,
    ENGINE_EVENT.REMOVE_CONVERSATION_LIST,
    ENGINE_EVENT.REMOVE_CONVERSATION,
    ENGINE_EVENT.GET_TOTAL_UNREAD_COUNT,
    ENGINE_EVENT.CLEAR_UNREAD_COUNT,
    ENGINE_EVENT.SEND_MESSAGE,
    ENGINE_EVENT.GET_HISTORY_MSGS,
    ENGINE_EVENT.DELETE_MESSAGES,
    ENGINE_EVENT.CLEAR_MESSAGES,
    ENGINE_EVENT.RECALL_MESSAGE,
    ENGINE_EVENT.JOIN_CHATROOM,
    ENGINE_EVENT.QUIT_CHATROOM,
    ENGINE_EVENT.GET_CHATROOM_INFO,
    ENGINE_EVENT.GET_CHATROOM_MSGS
  ]
  ...
  var APP_ENGINE_EVENT_LOG_TAG =
    ((_APP_ENGINE_EVENT_LOG = {}),
    (_APP_ENGINE_EVENT_LOG[ENGINE_EVENT.CONNECT] = {
      req: TAG.A_CONNECT_T,
  ...
  var MSGNOTIF_URL_TPL =
    '{protocol}{url}?version={version}&appkey={appkey}&userId={userId}&logId={logId}&deviceId={deviceId}&deviceInfo={deviceInfo}&platform={platform}'
  ...
  var getReportLogUrl = function getReportLogUrl(params) {
    ...
    switch (params.type) {
      ...
      case REPORT_TYPE.FULL:
        entireUrl = tplEngine$1(
          MSGNOTIF_URL_TPL,
          utils.extend(urlConf, {
            logId: params.logId
          })
        )
        break
  ...
  var SSMsg =
    ((_SSMsg = {}),
    (_SSMsg[PBName.UpStreamMessage] = ['sessionId', 'classname', 'content', 'pushText', 'userId', 'configFlag', 'appData']),
    (_SSMsg[PBName.DownStreamMessages] = ['list', 'syncTime', 'finished']),
    (_SSMsg[PBName.DownStreamMessage] = ['fromUserId', 'type', 'groupId', 'classname', 'content', 'dataTime', 'status', 'msgId']),
    (_SSMsg[PBName.SessionsAttQryInput] = ['nothing']),
    (_SSMsg[PBName.SessionsAttOutput] = ['inboxTime', 'sendboxTime', 'totalUnreadCount']),
    (_SSMsg[PBName.SyncRequestMsg] = ['syncTime', 'ispolling', 'isweb', 'isPullSend', 'isKeeping', 'sendBoxSyncTime']),
    (_SSMsg[PBName.ChrmPullMsg] = ['syncTime', 'count']),
    (_SSMsg[PBName.NotifyMsg] = ['type', 'time', 'chrmId']),
    (_SSMsg[PBName.HistoryMsgInput] = ['targetId', 'time', 'count', 'order']),
    (_SSMsg[PBName.HistoryMsgOuput] = ['list', 'syncTime', 'hasMsg']),
    (_SSMsg[PBName.RelationQryInput] = ['type', 'count', 'startTime', 'order']),
    (_SSMsg[PBName.RelationsOutput] = ['info']),
    (_SSMsg[PBName.DeleteSessionsInput] = ['sessions']),
    (_SSMsg[PBName.SessionInfo] = ['type', 'channelId']),
    (_SSMsg[PBName.DeleteSessionsOutput] = ['nothing']),
    (_SSMsg[PBName.RelationsInput] = ['type', 'msg', 'count', 'offset', 'startTime', 'endTime']),
    (_SSMsg[PBName.DeleteMsgInput] = ['type', 'conversationId', 'msgs']),
    (_SSMsg[PBName.CleanHisMsgInput] = ['targetId', 'dataTime', 'conversationType']),
    (_SSMsg[PBName.SessionMsgReadInput] = ['type', 'msgTime', 'channelId']),
    (_SSMsg[PBName.ChrmInput] = ['nothing']),
    (_SSMsg[PBName.QueryChatRoomInfoInput] = ['count', 'order']),
    (_SSMsg[PBName.QueryChatRoomInfoOutput] = ['userTotalNums', 'userInfos']),
    (_SSMsg[PBName.GetQNupTokenInput] = ['type']),
    (_SSMsg[PBName.GetQNdownloadUrlInput] = ['type', 'key', 'fileName']),
    (_SSMsg[PBName.GetQNupTokenOutput] = ['deadline', 'token']),
    (_SSMsg[PBName.GetQNdownloadUrlOutput] = ['downloadUrl']),
    (_SSMsg[PBName.SetChrmKV] = ['entry', 'bNotify', 'notification', 'type']),
    (_SSMsg[PBName.ChrmKVOutput] = ['entries', 'bFullUpdate', 'syncTime']),
    (_SSMsg[PBName.QueryChrmKV] = ['timestamp']),
    (_SSMsg[PBName.ChrmNotifyMsg] = ['type', 'time', 'chrmId']),
    (_SSMsg[PBName.SetUserSettingInput] = ['version', 'value']),
    (_SSMsg[PBName.SetUserSettingOutput] = ['version', 'reserve']),
    (_SSMsg[PBName.PullUserSettingInput] = ['version', 'reserve']),
    (_SSMsg[PBName.PullUserSettingOutput] = ['items', 'version']),
    _SSMsg)
    ...
    var b = void 0,
      c = (function () {
        ...
        function e(a, b) {
          var e, f, h
          return b
            ? ((a >>>= 0), (h = a >= 0 && 256 > a) && (f = d[a]) ? f : ((e = g(a, 0 > (0 | a) ? -1 : 0, !0)), h && (d[a] = e), e))
            : ((a |= 0), (h = a >= -128 && 128 > a) && (f = c[a]) ? f : ((e = g(a, 0 > a ? -1 : 0, !1)), h && (c[a] = e), e))
        }
        function f(a, b) {
        ...
        function i(a, b, c) {
          ...
          for (e = f(h(c, 8)), g = q, j = 0; j < a.length; j += 8)
            (k = Math.min(8, a.length - j)),
              ...
              8 > k ? ((m = f(h(c, k))), (g = g.mul(m).add(f(l)))) : ((g = g.mul(e)), (g = g.add(f(l))))
        ...
        return (
          ...
          (y.toString = function (a) {
            ...
            if (this.isNegative())
              return this.eq(x)
                ? ((b = f(a)), (c = this.div(b)), (d = c.mul(b).sub(this)), c.toString(a) + d.toInt().toString(a))
                : '-' + this.neg().toString(a)
          ...
          (y.compare = function (a) {
            ...
            return c && !d
              ...
              ? 1
              : this.unsigned
              ? a.high >>> 0 > this.high >>> 0 || (a.high === this.high && a.low >>> 0 > this.low >>> 0)
                ? -1
                : 1
            ...
            return this.isZero()
              ...
              : (b(a) || (a = j(a)),
                a.isZero()
                  ...
                  ? this.mul(a.neg()).neg()
                  : this.lt(p) && a.lt(p)
                  ? f(this.toNumber() * a.toNumber(), this.unsigned)
                  : ((c = this.high >>> 16),
                    (d = 65535 & this.high),
                    (e = this.low >>> 16),
                    (h = 65535 & this.low),
            ...
            if (this.unsigned) {
              ...
              if (this.eq(x))
                return a.eq(s) || a.eq(u)
                  ...
                  : a.eq(x)
                  ? s
                  : ((g = this.shr(1)), (c = g.div(a).shl(1)), c.eq(q) ? (a.isNegative() ? s : u) : ((d = this.sub(a.mul(c))), (e = c.add(d.div(a)))))
          ...
          (y.shiftLeft = function (a) {
            return (
              ...
              0 === (a &= 63)
                ? this
                : 32 > a
                ? g(this.low << a, (this.high << a) | (this.low >>> (32 - a)), this.unsigned)
                : g(0, this.low << (a - 32), this.unsigned)
            )
          }),
          (y.shl = y.shiftLeft),
          (y.shiftRight = function (a) {
            return (
              ...
              0 === (a &= 63)
                ? this
                : 32 > a
                ? g((this.low >>> a) | (this.high << (32 - a)), this.high >> a, this.unsigned)
                : g(this.high >> (a - 32), this.high >= 0 ? 0 : -1, this.unsigned)
            )
          }),
          (y.shr = y.shiftRight),
          (y.shiftRightUnsigned = function (a) {
            ...
            return (
              ...
              0 === a
                ...
                : ((c = this.high),
                  32 > a
                    ? ((d = this.low), g((d >>> a) | (c << (32 - a)), c >>> a, this.unsigned))
                    : 32 === a
                    ? g(c, 0, this.unsigned)
                    : g(c >>> (a - 32), 0, this.unsigned))
            )
          }),
      ...
      d = (function (a) {
        ...
        function g() {
          ...
          return function () {
            return 0 === arguments.length
              ? b.join('') + e.apply(String, a)
              : (a.length + arguments.length > 1024 && (b.push(e.apply(String, a)), (a.length = 0)), Array.prototype.push.apply(a, arguments), void 0)
          }
        }
        ...
        return (
          ...
          (b.concat = function (a, c, d, e) {
            var f, i, g, h, k, j
            for (('boolean' == typeof c || 'string' != typeof c) && ((e = d), (d = c), (c = void 0)), f = 0, g = 0, h = a.length; h > g; ++g)
              b.isByteBuffer(a[g]) || (a[g] = b.wrap(a[g], c)), (i = a[g].limit - a[g].offset), i > 0 && (f += i)
            if (0 === f) return new b(0, d, e)
            for (j = new b(f, d, e), g = 0; h > g; )
              (k = a[g++]), (i = k.limit - k.offset), 0 >= i || (j.view.set(k.view.subarray(k.offset, k.limit), j.offset), (j.offset += i))
          ...
          (b.wrap = function (a, d, e, f) {
            var g, h
            if (('string' != typeof d && ((f = e), (e = d), (d = void 0)), 'string' == typeof a))
              switch (('undefined' == typeof d && (d = 'utf8'), d)) {
                case 'base64':
            ...
            if (a instanceof Uint8Array)
              (g = new b(0, e, f)),
                a.length > 0 && ((g.buffer = a.buffer), (g.offset = a.byteOffset), (g.limit = a.byteOffset + a.byteLength), (g.view = new Uint8Array(a.buffer)))
            else if (a instanceof ArrayBuffer)
              (g = new b(0, e, f)),
                a.byteLength > 0 && ((g.buffer = a), (g.offset = 0), (g.limit = a.byteLength), (g.view = a.byteLength > 0 ? new Uint8Array(a) : null))
            else {
          ...
          (c.writeBitSet = function (a, b) {
            ...
            if ((c && (b = this.offset), !this.noAssert)) {
              ...
              if (((b >>>= 0), 0 > b || b + 0 > this.buffer.byteLength))
          ...
          (c.readBytes = function (a, b) {
            ...
            if ((c && (b = this.offset), !this.noAssert)) {
              if ('number' != typeof b || 0 !== b % 1) throw TypeError('Illegal offset: ' + b + ' (not an integer)')
              if (((b >>>= 0), 0 > b || b + a > this.buffer.byteLength))
          ...
          (c.writeInt8 = function (a, b) {
            ...
            return (
              (b += 1), (d = this.buffer.byteLength), b > d && this.resize((d *= 2) > b ? d : b), (b -= 1), (this.view[b] = a), c && (this.offset += 1), this
            )
          }),
          ...
          (c.readInt8 = function (a) {
            ...
            if ((b && (a = this.offset), !this.noAssert)) {
              ...
              if (((a >>>= 0), 0 > a || a + 1 > this.buffer.byteLength))
          ...
          (c.writeInt16 = function (a, b) {
            ...
            return (
              ...
              (b -= 2),
              this.littleEndian
                ? ((this.view[b + 1] = (65280 & a) >>> 8), (this.view[b] = 255 & a))
                : ((this.view[b] = (65280 & a) >>> 8), (this.view[b + 1] = 255 & a)),
              c && (this.offset += 2),
              this
            )
          }),
          ...
          (c.readInt16 = function (a) {
            ...
            if ((b && (a = this.offset), !this.noAssert)) {
              if ('number' != typeof a || 0 !== a % 1) throw TypeError('Illegal offset: ' + a + ' (not an integer)')
              if (((a >>>= 0), 0 > a || a + 2 > this.buffer.byteLength))
          ...
          (c.writeInt32 = function (a, b) {
            ...
            return (
              ...
              (b -= 4),
              this.littleEndian
                ? ((this.view[b + 3] = 255 & (a >>> 24)), (this.view[b + 2] = 255 & (a >>> 16)), (this.view[b + 1] = 255 & (a >>> 8)), (this.view[b] = 255 & a))
                : ((this.view[b] = 255 & (a >>> 24)),
          ...
          (c.readInt32 = function (a) {
            ...
            if ((b && (a = this.offset), !this.noAssert)) {
              if ('number' != typeof a || 0 !== a % 1) throw TypeError('Illegal offset: ' + a + ' (not an integer)')
              if (((a >>>= 0), 0 > a || a + 4 > this.buffer.byteLength))
                throw RangeError('Illegal offset: 0 <= ' + a + ' (+' + 4 + ') <= ' + this.buffer.byteLength)
            }
            return (
              (c = 0),
              this.littleEndian
                ? ((c = this.view[a + 2] << 16), (c |= this.view[a + 1] << 8), (c |= this.view[a]), (c += (this.view[a + 3] << 24) >>> 0))
                : ((c = this.view[a + 1] << 16), (c |= this.view[a + 2] << 8), (c |= this.view[a + 3]), (c += (this.view[a] << 24) >>> 0)),
              (c |= 0),
              b && (this.offset += 4),
              c
            )
          ...
          a &&
            ((c.writeInt64 = function (b, c) {
              ...
              if ((d && (c = this.offset), !this.noAssert)) {
                ...
                if (((c >>>= 0), 0 > c || c + 0 > this.buffer.byteLength))
            ...
            (c.readInt64 = function (b) {
              ...
              if ((c && (b = this.offset), !this.noAssert)) {
                if ('number' != typeof b || 0 !== b % 1) throw TypeError('Illegal offset: ' + b + ' (not an integer)')
                if (((b >>>= 0), 0 > b || b + 8 > this.buffer.byteLength))
          ...
          (c.readFloat64 = function (a) {
            ...
            if ((b && (a = this.offset), !this.noAssert)) {
              if ('number' != typeof a || 0 !== a % 1) throw TypeError('Illegal offset: ' + a + ' (not an integer)')
              if (((a >>>= 0), 0 > a || a + 8 > this.buffer.byteLength))
          ...
          (c.readVarint32 = function (a) {
            ...
            return (d |= 0), b ? ((this.offset = a), d) : { value: d, length: c }
          }),
          ...
          a &&
            ...
            (c.writeVarint64 = function (c, d) {
              ...
              if ((e && (d = this.offset), !this.noAssert)) {
                ...
                if (((d >>>= 0), 0 > d || d + 0 > this.buffer.byteLength))
                  throw RangeError('Illegal offset: 0 <= ' + d + ' (+' + 0 + ') <= ' + this.buffer.byteLength)
              }
              switch (
                ('number' == typeof c ? (c = a.fromNumber(c, !1)) : 'string' == typeof c ? (c = a.fromString(c, !1)) : c.unsigned !== !1 && (c = c.toSigned()),
            ...
            (c.readVarint64 = function (b) {
              ...
              if ((c && (b = this.offset), !this.noAssert)) {
                if ('number' != typeof b || 0 !== b % 1) throw TypeError('Illegal offset: ' + b + ' (not an integer)')
                if (((b >>>= 0), 0 > b || b + 1 > this.buffer.byteLength))
                          ...
                          (128 & h || (this.noAssert && 'undefined' == typeof h)) &&
                            ...
                            (128 & h || (this.noAssert && 'undefined' == typeof h)) &&
                              ...
                              (128 & h || (this.noAssert && 'undefined' == typeof h)) &&
                                ...
                                (g = 127 & h),
                                (128 & h || (this.noAssert && 'undefined' == typeof h)) &&
                                  ((h = this.view[b++]), (g |= (127 & h) << 7), 128 & h || (this.noAssert && 'undefined' == typeof h)))))))))))
              )
                throw Error('Buffer overrun')
              return (i = a.fromBits(e | (f << 28), (f >>> 4) | (g << 24), !1)), c ? ((this.offset = b), i) : { value: i, length: b - d }
            }),
          ...
          (c.writeCString = function (a, b) {
            ...
            if ((c && (b = this.offset), (e = a.length), !this.noAssert)) {
              ...
              for (d = 0; e > d; ++d) if (0 === a.charCodeAt(d)) throw RangeError('Illegal str: Contains NULL-characters')
              if ('number' != typeof b || 0 !== b % 1) throw TypeError('Illegal offset: ' + b + ' (not an integer)')
              if (((b >>>= 0), 0 > b || b + 0 > this.buffer.byteLength))
                throw RangeError('Illegal offset: 0 <= ' + b + ' (+' + 0 + ') <= ' + this.buffer.byteLength)
            }
          ...
          (c.readCString = function (a) {
            ...
            return (
              ...
              b ? ((this.offset = a), e()) : { string: e(), length: a - c }
            )
          }),
          (c.writeIString = function (a, b) {
            ...
            if (
              ...
              (b -= 4 + e),
              this.littleEndian
                ? ((this.view[b + 3] = 255 & (e >>> 24)), (this.view[b + 2] = 255 & (e >>> 16)), (this.view[b + 1] = 255 & (e >>> 8)), (this.view[b] = 255 & e))
                : ((this.view[b] = 255 & (e >>> 24)),
          ...
          (c.readIString = function (a) {
            ...
            return (
              ...
              (a += f.length),
              c ? ((this.offset = a), f.string) : { string: f.string, length: a - d }
            )
          }),
          (b.METRICS_CHARS = 'c'),
          (b.METRICS_BYTES = 'b'),
          ...
          (c.readUTF8String = function (a, c, d) {
            ...
            if (((f = 0), (h = d), c === b.METRICS_CHARS)) {
              ...
              return e ? ((this.offset = d), i()) : { string: i(), length: d - h }
            }
            if (c === b.METRICS_BYTES) {
              if (!this.noAssert) {
                if ('number' != typeof d || 0 !== d % 1) throw TypeError('Illegal offset: ' + d + ' (not an integer)')
                if (((d >>>= 0), 0 > d || d + a > this.buffer.byteLength))
          ...
          (c.append = function (a, c, d) {
            var e, f, g
            if (
              (('number' == typeof c || 'string' != typeof c) && ((d = c), (c = void 0)), (e = 'undefined' == typeof d), e && (d = this.offset), !this.noAssert)
            ) {
              if ('number' != typeof d || 0 !== d % 1) throw TypeError('Illegal offset: ' + d + ' (not an integer)')
              if (((d >>>= 0), 0 > d || d + 0 > this.buffer.byteLength))
                throw RangeError('Illegal offset: 0 <= ' + d + ' (+' + 0 + ') <= ' + this.buffer.byteLength)
          ...
          (c.clone = function (a) {
            ...
            return (
              a
                ? ((c.buffer = new ArrayBuffer(this.buffer.byteLength)), (c.view = new Uint8Array(c.buffer)))
                : ((c.buffer = this.buffer), (c.view = this.view)),
          ...
          (c.compact = function (a, b) {
            ...
            if (('undefined' == typeof a && (a = this.offset), 'undefined' == typeof b && (b = this.limit), !this.noAssert)) {
              ...
              if (((b >>>= 0), 0 > a || a > b || b > this.buffer.byteLength))
                throw RangeError('Illegal range: 0 <= ' + a + ' <= ' + b + ' <= ' + this.buffer.byteLength)
            }
            return 0 === a && b === this.buffer.byteLength
              ? this
              : ((c = b - a),
                0 === c
                  ? ((this.buffer = d), (this.view = null), this.markedOffset >= 0 && (this.markedOffset -= a), (this.offset = 0), (this.limit = 0), this)
                  : ((e = new ArrayBuffer(c)),
                    (f = new Uint8Array(e)),
          ...
          (c.copy = function (a, c) {
            if (('undefined' == typeof a && (a = this.offset), 'undefined' == typeof c && (c = this.limit), !this.noAssert)) {
              ...
              if (((c >>>= 0), 0 > a || a > c || c > this.buffer.byteLength))
          ...
          (c.copyTo = function (a, c, d, e) {
            ...
            if (
              ((c = (g = 'undefined' == typeof c) ? a.offset : 0 | c),
            ...
            return (
              (h = e - d), 0 === h ? a : (a.ensureCapacity(c + h), a.view.set(this.view.subarray(d, e), c), f && (this.offset += h), g && (a.offset += h), this)
            )
          }),
          ...
          (c.fill = function (a, b, c) {
            ...
            if (
              ...
              if (((c >>>= 0), 0 > b || b > c || c > this.buffer.byteLength))
          ...
          (c.mark = function (a) {
            if (((a = 'undefined' == typeof a ? this.offset : a), !this.noAssert)) {
              if ('number' != typeof a || 0 !== a % 1) throw TypeError('Illegal offset: ' + a + ' (not an integer)')
              if (((a >>>= 0), 0 > a || a + 0 > this.buffer.byteLength))
          ...
          (c.prepend = function (a, c, d) {
            ...
            return (
              ...
              0 >= f
                ...
                : ((g = f - d),
                  g > 0
                    ? ((h = new ArrayBuffer(this.buffer.byteLength + g)),
                      (i = new Uint8Array(h)),
          ...
          (c.toBuffer = function (a) {
            ...
            return a || 0 !== b || c !== this.buffer.byteLength
              ? b === c
                ? d
                : ((e = new ArrayBuffer(c - b)), new Uint8Array(e).set(new Uint8Array(this.buffer).subarray(b, c), 0), e)
              : this.buffer
          }),
          ...
          (j = (function () {
            var d,
              ...
              a = {},
              b = [
                65, 66, 67, 68, 69, 70, 71, 72, 73, 74, 75, 76, 77, 78, 79, 80, 81, 82, 83, 84, 85, 86, 87, 88, 89, 90, 97, 98, 99, 100, 101, 102, 103, 104,
                  ...
                  c(b[63 & (d >> 2)]),
                    ...
                    null !== (d = a())
                      ? ((e |= 15 & (d >> 4)),
                        c(b[63 & (e | (15 & (d >> 4)))]),
                        (e = (15 & d) << 2),
                        null !== (d = a()) ? (c(b[63 & (e | (3 & (d >> 6)))]), c(b[63 & d])) : (c(b[63 & e]), c(61)))
                      : (c(b[63 & e]), c(61), c(61))
              }),
              (a.decode = function (a, b) {
                ...
                for (var d, e, f; null !== (d = a()); )
                  if (
                    ...
                    null !== (d = a()) && ((f = c[d]), 'undefined' == typeof f && g(d), b(((e << 2) >>> 0) | ((48 & f) >> 4)), null !== (d = a())))
                  ) {
          ...
          (b.fromHex = function (a, c, d) {
            ...
            for (e = a.length, f = new b(0 | (e / 2), c), h = 0, i = 0; e > h; h += 2) {
              if (((g = parseInt(a.substring(h, h + 2), 16)), !d && (!isFinite(g) || 0 > g || g > 255)))
              ...
              (a.encodeUTF8 = function (a, b) {
                ...
                for (
                  ...
                  128 > c
                    ? b(127 & c)
                    : 2048 > c
                    ? (b(192 | (31 & (c >> 6))), b(128 | (63 & c)))
                    : 65536 > c
                    ? (b(224 | (15 & (c >> 12))), b(128 | (63 & (c >> 6))), b(128 | (63 & c)))
                    : (b(240 | (7 & (c >> 18))), b(128 | (63 & (c >> 12))), b(128 | (63 & (c >> 6))), b(128 | (63 & c))),
                    (c = null)
              }),
      ...
      e = (function (b, c) {
        ...
        return (
          ...
          (e.TYPES = {
            int32: { name: 'int32', wireType: e.WIRE_TYPES.VARINT, defaultValue: 0 },
            uint32: { name: 'uint32', wireType: e.WIRE_TYPES.VARINT, defaultValue: 0 },
            sint32: { name: 'sint32', wireType: e.WIRE_TYPES.VARINT, defaultValue: 0 },
            int64: { name: 'int64', wireType: e.WIRE_TYPES.VARINT, defaultValue: e.Long ? e.Long.ZERO : void 0 },
            uint64: { name: 'uint64', wireType: e.WIRE_TYPES.VARINT, defaultValue: e.Long ? e.Long.UZERO : void 0 },
            sint64: { name: 'sint64', wireType: e.WIRE_TYPES.VARINT, defaultValue: e.Long ? e.Long.ZERO : void 0 },
            bool: { name: 'bool', wireType: e.WIRE_TYPES.VARINT, defaultValue: !1 },
            double: { name: 'double', wireType: e.WIRE_TYPES.BITS64, defaultValue: 0 },
            string: { name: 'string', wireType: e.WIRE_TYPES.LDELIM, defaultValue: '' },
            bytes: { name: 'bytes', wireType: e.WIRE_TYPES.LDELIM, defaultValue: null },
            fixed32: { name: 'fixed32', wireType: e.WIRE_TYPES.BITS32, defaultValue: 0 },
            sfixed32: { name: 'sfixed32', wireType: e.WIRE_TYPES.BITS32, defaultValue: 0 },
            fixed64: { name: 'fixed64', wireType: e.WIRE_TYPES.BITS64, defaultValue: e.Long ? e.Long.UZERO : void 0 },
            sfixed64: { name: 'sfixed64', wireType: e.WIRE_TYPES.BITS64, defaultValue: e.Long ? e.Long.ZERO : void 0 },
            float: { name: 'float', wireType: e.WIRE_TYPES.BITS32, defaultValue: 0 },
            enum: { name: 'enum', wireType: e.WIRE_TYPES.VARINT, defaultValue: 0 },
            message: { name: 'message', wireType: e.WIRE_TYPES.LDELIM, defaultValue: null },
            group: { name: 'group', wireType: e.WIRE_TYPES.STARTGROUP, defaultValue: null }
          }),
          (e.MAP_KEY_TYPES = [
            e.TYPES.int32,
            e.TYPES.sint32,
          ...
          (e.ID_MIN = 1),
          (e.ID_MAX = 536870911),
          (e.convertFieldsToCamelCase = !1),
          (e.populateAccessors = !0),
          (e.populateDefaults = !0),
          (e.Util = (function () {
            var a = {}
            return (
              (a.IS_NODE = !('object' != typeof process || '[object process]' != process + '' || process.browser)),
              (a.XHR = function () {
                var c,
                  a = [
                    function () {
              ...
              (a.fetch = function (b, c) {
                if ((c && 'function' != typeof c && (c = null), a.IS_NODE))
                  ...
                  if (
                    ...
                    return e.send(null), 200 == e.status || (0 == e.status && 'string' == typeof e.responseText) ? e.responseText : null
                  if (
          ...
          (e.DotProto = (function (a, b) {
            ...
            return (
              (e._readString = function () {
                var c,
                  a = '"' === this._stringOpen ? b.STRING_DQ : b.STRING_SQ
              ...
              (g.parse = function () {
                var c,
                  a = { name: '[ROOT]', package: null, messages: [], enums: [], imports: [], options: {}, services: [] },
                  d = !0
                try {
                  for (; (c = this.tn.next()); )
                    switch (c) {
                      ...
                      case 'import':
                        ...
                        ;(c = this.tn.peek()), 'public' === c && this.tn.next(), (c = this._readString()), this.tn.skip(';'), a.imports.push(c)
                        break
                      case 'syntax':
              ...
              (g._parseOption = function (a, c) {
                ...
                ;(f = d),
                  e && (this.tn.skip(')'), (f = '(' + f + ')'), (d = this.tn.peek()), b.FQTYPEREF.test(d) && ((f += d), this.tn.next())),
                  this.tn.skip('='),
              ...
              (g._parseService = function (a) {
                ...
                for (d = c, e = { name: d, rpc: {}, options: {} }, this.tn.skip('{'); '}' !== (c = this.tn.next()); )
              ...
              (g._parseServiceRPC = function (a) {
                ...
                if (
                  ((e = d),
                  (f = { request: null, response: null, request_stream: !1, response_stream: !1, options: {} }),
                  this.tn.skip('('),
                  (d = this.tn.next()),
                  'stream' === d.toLowerCase() && ((f.request_stream = !0), (d = this.tn.next())),
                  !b.TYPEREF.test(d))
                )
                  throw Error('illegal rpc service request type: ' + d)
                if (((f.request = d), this.tn.skip(')'), (d = this.tn.next()), 'returns' !== d.toLowerCase()))
                  throw Error('illegal rpc service request type delimiter: ' + d)
                if (
                  (this.tn.skip('('),
                  (d = this.tn.next()),
                  'stream' === d.toLowerCase() && ((f.response_stream = !0), (d = this.tn.next())),
                  (f.response = d),
                  this.tn.skip(')'),
                  (d = this.tn.peek()),
                  '{' === d)
              ...
              (g._parseMessage = function (a, c) {
                var d = !!c,
                  e = this.tn.next(),
                  f = { name: '', fields: [], enums: [], messages: [], options: {}, services: [], oneofs: {} }
                if (!b.NAME.test(e)) throw Error('illegal ' + (d ? 'group' : 'message') + ' name: ' + e)
                for (
                  f.name = e,
                    d && (this.tn.skip('='), (c.id = h(this.tn.next())), (f.isGroup = !0)),
                    e = this.tn.peek(),
                  ...
                  else if ('extensions' === e) f.extensions = this._parseExtensionRanges()
              ...
              (g._parseMessageField = function (a, c, d) {
                ...
                if (((e = { rule: c, type: '', name: '', options: {}, id: 0 }), 'map' === c)) {
                  ...
                  if (((e.keytype = f), this.tn.skip(','), (f = this.tn.next()), !b.TYPE.test(f) && !b.TYPEREF.test(f)))
              ...
              (g._parseFieldOptions = function (a) {
                this.tn.skip('[')
                for (var b, c = !0; ']' !== (b = this.tn.peek()); ) c || this.tn.skip(','), this._parseOption(a, !0), (c = !1)
                this.tn.next()
              }),
              (g._parseEnum = function (a) {
                var e,
                  c = { name: '', values: [], options: {} },
                  d = this.tn.next()
                ...
                for (c.name = d, this.tn.skip('{'); '}' !== (d = this.tn.next()); )
                  if ('option' === d) this._parseOption(c)
                    ...
                    if (!b.NAME.test(d)) throw Error('illegal name: ' + d)
                    this.tn.skip('='),
                      (e = { name: d, id: h(this.tn.next(), !0) }),
                      (d = this.tn.peek()),
                      '[' === d && this._parseFieldOptions({ options: {} }),
                      this.tn.skip(';'),
                      c.values.push(e)
                  }
              ...
              (g._parseExtend = function (a) {
                ...
                for (d = { ref: c, fields: [] }, this.tn.skip('{'); '}' !== (c = this.tn.next()); )
          ...
          (e.Reflect = (function (a) {
            function k(b) {
              if (('string' == typeof b && (b = a.TYPES[b]), 'undefined' == typeof b.defaultValue))
            ...
            function l(b, c) {
              ...
              if ('string' == typeof b) return a.Long.fromString(b, c || !1, 10)
              if ('number' == typeof b) return a.Long.fromNumber(b, c || !1)
            ...
            return (
              ...
              (h = g.prototype = Object.create(d.prototype)),
              ...
              (h.addChild = function (a) {
                ...
                if ((b = this.getChild(a.name)))
                  if (b instanceof m.Field && b.name !== b.originalName && null === this.getChild(b.originalName)) b.name = b.originalName
                    ...
                    if (!(a instanceof m.Field && a.name !== a.originalName && null === this.getChild(a.originalName)))
              ...
              (h.qn = function (a) {
                var e,
                  ...
                  b = [],
                  d = a
                do b.unshift(d.name), (d = d.parent)
                while (null !== d)
              ...
              (h.build = function () {
                ...
                return Object.defineProperty && Object.defineProperty(a, '$options', { value: this.buildOpt() }), a
              }),
              (h.buildOpt = function () {
                var c,
                  d,
              ...
              (c.Namespace = g),
              (i = function (b, c, d, e) {
                if (((this.type = b), (this.resolvedType = c), (this.isMapKey = d), (this.syntax = e), d && a.MAP_KEY_TYPES.indexOf(b) < 0))
                  throw Error('Invalid map key type: ' + b.name)
              }),
              (j = i.prototype),
              (i.defaultFieldValue = k),
              (j.verifyValue = function (c) {
                var f,
                  g,
                  h,
                  d = function (a, b) {
                ...
                switch (this.type) {
                  ...
                  case a.TYPES.sfixed32:
                    return ('number' != typeof c || (c === c && 0 !== c % 1)) && d(typeof c, 'not an integer'), c > 4294967295 ? 0 | c : c
                  case a.TYPES.uint32:
                  case a.TYPES.fixed32:
                    return ('number' != typeof c || (c === c && 0 !== c % 1)) && d(typeof c, 'not an integer'), 0 > c ? c >>> 0 : c
                  case a.TYPES.int64:
                  case a.TYPES.sint64:
                  ...
                  case a.TYPES.bool:
                    return 'boolean' != typeof c && d(typeof c, 'not a boolean'), c
                  case a.TYPES['float']:
                  case a.TYPES['double']:
                    return 'number' != typeof c && d(typeof c, 'not a number'), c
                  case a.TYPES.string:
                    return 'string' == typeof c || (c && c instanceof String) || d(typeof c, 'not a string'), '' + c
                  case a.TYPES.bytes:
                  ...
                  case a.TYPES['enum']:
                    ...
                    if ('proto3' === this.syntax)
                      return (
                        ('number' != typeof c || (c === c && 0 !== c % 1)) && d(typeof c, 'not an integer'),
                        (c > 4294967295 || 0 > c) && d(typeof c, 'not in range for uint32'),
                        c
                      )
                    d(c, 'not a valid enum value')
                  case a.TYPES.group:
                  case a.TYPES.message:
                    if (((c && 'object' == typeof c) || d(typeof c, 'object expected'), c instanceof this.resolvedType.clazz)) return c
              ...
              (j.calculateLength = function (b, c) {
                ...
                switch (this.type) {
                  case a.TYPES.int32:
                    return 0 > c ? f.calculateVarint64(c) : f.calculateVarint32(c)
                  case a.TYPES.uint32:
              ...
              (j.decode = function (b, c, d) {
                ...
                switch (this.type) {
                  ...
                  case a.TYPES.bytes:
                    if (((f = b.readVarint32()), b.remaining() < f))
              ...
              (n = m.prototype = Object.create(g.prototype)),
              (n.build = function (c) {
                var d, h, e, g
                ...
                for (
                  d = (function (a, c) {
                    function k(b, c, d, e) {
                      ...
                      if (null === b || 'object' != typeof b)
                        return e && e instanceof a.Reflect.Enum && ((g = a.Reflect.Enum.getName(e.object, b)), null !== g) ? g : b
                    ...
                    var i,
                      j,
                      d = c.getChildren(a.Reflect.Message.Field),
                      e = c.getChildren(a.Reflect.Message.OneOf),
                      g = function (b) {
                        var i, j, k, l
                        for (a.Builder.Message.call(this), i = 0, j = e.length; j > i; ++i) this[e[i].name] = null
                        for (i = 0, j = d.length; j > i; ++i)
                          (k = d[i]),
                            (this[k.name] = k.repeated ? [] : k.map ? new a.Map(k) : null),
                        ...
                        if (arguments.length > 0)
                          if (
                            ...
                            null === b ||
                            'object' != typeof b ||
                            !('function' != typeof b.encode || b instanceof g) ||
                            Array.isArray(b) ||
                            b instanceof a.Map ||
                            f.isByteBuffer(b) ||
                            b instanceof ArrayBuffer ||
                            (a.Long && b instanceof a.Long)
                          )
                            for (i = 0, j = arguments.length; j > i; ++i) 'undefined' != typeof (l = arguments[i]) && this.$set(d[i].name, l)
                          else this.$set(b)
                      },
                      h = (g.prototype = Object.create(a.Builder.Message.prototype))
                    for (
                      h.add = function (b, d, e) {
                        ...
                        return null === this[b] && (this[b] = []), this[b].push(d), this
                      },
                        h.$add = h.add,
                        h.set = function (b, d, e) {
                          ...
                          if (b && 'object' == typeof b) {
                            e = d
                            for (f in b) b.hasOwnProperty(f) && 'undefined' != typeof (d = b[f]) && this.$set(f, d, e)
                            return this
                          }
                          if (((g = c._fieldsByName[b]), e)) this[b] = d
                          else {
                          ...
                          return (
                            g &&
                              ...
                              ((h = this[g.oneof.name]),
                              null !== d
                                ? (null !== h && h !== g.name && (this[h] = null), (this[g.oneof.name] = g.name))
                                : h === b && (this[g.oneof.name] = null)),
                            this
                          )
                        },
                        h.$set = h.set,
                      ...
                      (j = d[i]),
                        j instanceof a.Reflect.Message.ExtensionField ||
                          (c.builder.options.populateAccessors &&
                            (function (a) {
                              var d,
                                e,
                                f,
                                b = a.originalName.replace(/(_[a-zA-Z])/g, function (a) {
                              ...
                              ;(b = b.substring(0, 1).toUpperCase() + b.substring(1)),
                                ...
                                null === c.getChild('set' + b) && (h['set' + b] = e),
                                null === c.getChild('set_' + d) && (h['set_' + d] = e),
                                null === c.getChild('get' + b) && (h['get' + b] = f),
                                null === c.getChild('get_' + d) && (h['get_' + d] = f)
                            })(j))
                    return (
                      (h.encode = function (a, d) {
                        var e, f
                        'boolean' == typeof a && ((d = a), (a = void 0)), (e = !1), a || ((a = new b()), (e = !0)), (f = a.littleEndian)
                        try {
                      ...
                      (h.toBase64 = h.encode64),
                      (h.encodeHex = function () {
                        try {
                      ...
                      (g.decode = function (a, b) {
                        var d, e
                        'string' == typeof a && (a = f.wrap(a, b ? b : 'base64')), (a = f.isByteBuffer(a) ? a : f.wrap(a)), (d = a.littleEndian)
                        try {
                      ...
                      (g.decodeDelimited = function (a, b) {
                        var d, e, g
                        if (('string' == typeof a && (a = f.wrap(a, b ? b : 'base64')), (a = f.isByteBuffer(a) ? a : f.wrap(a)), a.remaining() < 1)) return null
                      ...
                      Object.defineProperty &&
                        (Object.defineProperty(g, '$options', { value: c.buildOpt() }),
                        Object.defineProperty(h, '$options', { value: g['$options'] }),
                        Object.defineProperty(g, '$type', { value: c }),
                        Object.defineProperty(h, '$type', { value: c })),
                      g
                    )
                  })(a, this),
                    this._fields = [],
                  ...
                  if (((h = this.children[e]), h instanceof t || h instanceof m || h instanceof x)) {
                    if (d.hasOwnProperty(h.name))
                      throw Error('Illegal reflect child of ' + this.toString(!0) + ': ' + h.toString(!0) + " cannot override static property '" + h.name + "'")
                    d[h.name] = h.build()
                  } else if (h instanceof m.Field) h.build(), this._fields.push(h), (this._fieldsById[h.id] = h), (this._fieldsByName[h.name] = h)
                  else if (!(h instanceof m.OneOf || h instanceof w))
              ...
              (n.encode = function (a, b, c) {
                ...
                for (f = 0, g = this._fields.length; g > f; ++f)
                  (e = this._fields[f]), (h = a[e.name]), e.required && null === h ? null === d && (d = e) : e.encode(c ? h : e.verifyValue(h), b, a)
              ...
              (n.calculate = function (a) {
                for (var e, f, b = 0, c = 0, d = this._fields.length; d > c; ++c) {
                  if (((e = this._fields[c]), (f = a[e.name]), e.required && null === f))
              ...
              (n.decode = function (b, c, d) {
                ...
                for (c = 'number' == typeof c ? c : -1, e = b.offset, f = new this.clazz(); b.offset < e + c || (-1 === c && b.remaining() > 0); ) {
                  ...
                  if ((j = this._fieldsById[i]))
                    j.repeated && !j.options.packed
                      ? f[j.name].push(j.decode(h, b))
                      : j.map
                      ? ((l = j.decode(h, b)), f[j.name].set(l[0], l[1]))
                      : ((f[j.name] = j.decode(h, b)),
                        j.oneof && ((m = f[j.oneof.name]), null !== m && m !== j.name && (f[m] = null), (f[j.oneof.name] = j.name)))
                  else
                    switch (h) {
                      case a.WIRE_TYPES.VARINT:
                        b.readVarint32()
                ...
                for (n = 0, p = this._fields.length; p > n; ++n)
                  if (((j = this._fields[n]), null === f[j.name]))
                    if ('proto3' === this.syntax) f[j.name] = j.defaultValue
                      ...
                      a.populateDefaults && null !== j.defaultValue && (f[j.name] = j.defaultValue)
                    }
                return f
              }),
              (c.Message = m),
              (p = function (b, c, e, f, g, h, i, j, k, l) {
                d.call(this, b, c, h),
                  ...
                  (this.oneof = k || null),
                  (this.syntax = l || 'proto2'),
                  (this.originalName = this.name),
                  (this.element = null),
                  (this.keyElement = null),
                  !this.builder.options.convertFieldsToCamelCase || this instanceof m.ExtensionField || (this.name = a.Util.toCamelCase(this.name))
              }),
              (q = p.prototype = Object.create(d.prototype)),
              (q.build = function () {
                ;(this.element = new i(this.type, this.resolvedType, !1, this.syntax)),
                  ...
                  'proto3' !== this.syntax || this.repeated || this.map
                    ? 'undefined' != typeof this.options['default'] && (this.defaultValue = this.verifyValue(this.options['default']))
                    : (this.defaultValue = i.defaultFieldValue(this.type))
              }),
              (q.verifyValue = function (b, c) {
                ...
                if (
                  ...
                  return (
                    this.required && d(typeof b, 'required'),
                ...
                return this.map && !c
                  ? b instanceof a.Map
                    ? b
                    : (b instanceof Object || d(typeof b, 'expected ProtoBuf.Map or raw object for map field'), new a.Map(this, b))
                  : (!this.repeated && Array.isArray(b) && d(typeof b, 'no array expected'), this.element.verifyValue(b))
              }),
              (q.hasWirePresence = function (b, c) {
                if ('proto3' !== this.syntax) return null !== b
              ...
              (q.encode = function (b, c, d) {
                ...
                if (null === b || (this.repeated && 0 == b.length)) return c
                try {
                  if (this.repeated)
                    if (this.options.packed && a.PACKABLE_WIRE_TYPES.indexOf(this.type.wireType) >= 0) {
                      ...
                      ;(h = c.offset - g),
                        (i = f.calculateVarint32(h)),
                        i > 1 && ((j = c.slice(g, c.offset)), (g += i - 1), (c.offset = g), c.append(j)),
                        c.writeVarint32(h, g - i)
                    } else for (e = 0; e < b.length; e++) c.writeVarint32((this.id << 3) | this.type.wireType), this.element.encodeValue(this.id, b[e], c)
                  else
                    this.map
                      ? b.forEach(function (b, d) {
                          var g =
                            f.calculateVarint32(8 | this.keyType.wireType) +
                            this.keyElement.calculateLength(1, d) +
                            f.calculateVarint32(16 | this.type.wireType) +
                            this.element.calculateLength(2, b)
                      ...
                      : this.hasWirePresence(b, d) && (c.writeVarint32((this.id << 3) | this.type.wireType), this.element.encodeValue(this.id, b, c))
                } catch (k) {
              ...
              (q.calculate = function (b, c) {
                var d, e, g
                if (((b = this.verifyValue(b)), null === this.type || 'object' != typeof this.type))
                  throw Error('[INTERNAL] Unresolved type in ' + this.toString(!0) + ': ' + this.type)
                if (null === b || (this.repeated && 0 == b.length)) return 0
                d = 0
                try {
                  if (this.repeated)
                    if (this.options.packed && a.PACKABLE_WIRE_TYPES.indexOf(this.type.wireType) >= 0) {
                    ...
                    this.map
                      ? b.forEach(function (b, c) {
                          var g =
                            f.calculateVarint32(8 | this.keyType.wireType) +
                            this.keyElement.calculateLength(1, c) +
                            f.calculateVarint32(16 | this.type.wireType) +
                            this.element.calculateLength(2, b)
                          ;(d += f.calculateVarint32((this.id << 3) | a.WIRE_TYPES.LDELIM)), (d += f.calculateVarint32(g)), (d += g)
                        }, this)
                      : this.hasWirePresence(b, c) &&
                        ((d += f.calculateVarint32((this.id << 3) | this.type.wireType)), (d += this.element.calculateLength(this.id, b)))
                } catch (h) {
              ...
              (q.decode = function (b, c, d) {
                var e,
                  ...
                  m,
                  g =
                    (!this.map && b == this.type.wireType) ||
                    (!d && this.repeated && this.options.packed && b == a.WIRE_TYPES.LDELIM) ||
                    (this.map && b == a.WIRE_TYPES.LDELIM)
                ...
                if (this.map) {
                  if (((j = i.defaultFieldValue(this.keyType)), (e = i.defaultFieldValue(this.type)), (f = c.readVarint32()), c.remaining() < f))
                  ...
                  for (k = c.clone(), k.limit = k.offset + f, c.offset += f; k.remaining() > 0; )
                    if (((l = k.readVarint32()), (b = 7 & l), (m = l >>> 3), 1 === m)) j = this.keyElement.decode(k, b, m)
                    else {
              ...
              (u = t.prototype = Object.create(g.prototype)),
              (u.build = function (b) {
                var c, d, e, f
              ...
              (y = x.prototype = Object.create(g.prototype)),
              (y.build = function (b) {
                return this.clazz && !b
                  ? this.clazz
                  : (this.clazz = (function (a, b) {
                      var g,
                        c = function (b) {
                        ...
                        e = b.getChildren(a.Reflect.Service.RPCMethod)
                      for (g = 0; g < e.length; g++)
                        !(function (a) {
                          ;(d[a.name] = function (c, d) {
                            try {
                              ...
                              c instanceof a.resolvedRequestType.clazz || (c = new a.resolvedRequestType.clazz(c)),
                                this.rpcImpl(a.fqn(), c, function (c, e) {
                                  ...
                                  return e && e instanceof a.resolvedResponseType.clazz
                                    ? (d(null, e), void 0)
                                    : (d(Error('Illegal response type received in service method ' + b.name + '#' + a.name)), void 0)
                                })
                            } catch (e) {
                            ...
                            Object.defineProperty &&
                              (Object.defineProperty(c[a.name], '$options', { value: a.buildOpt() }),
                              Object.defineProperty(d[a.name], '$options', { value: c[a.name]['$options'] }))
                        })(e[g])
                      return (
                        Object.defineProperty &&
                          (Object.defineProperty(c, '$options', { value: b.buildOpt() }),
                          Object.defineProperty(d, '$options', { value: c['$options'] }),
                          Object.defineProperty(c, '$type', { value: b }),
                          Object.defineProperty(d, '$type', { value: b })),
                        c
                      )
                    })(a, this))
              }),
              ...
              (A = z.prototype = Object.create(d.prototype)),
              (A.buildOpt = h.buildOpt),
              (c.Service.Method = z),
                ...
                for (e = [b]; e.length > 0; ) {
                  ...
                  for (; b.length > 0; ) {
                    if (((f = b.shift()), d.isMessage(f))) {
                      if (
                        ((g = new c.Message(this, this.ptr, f.name, f.options, f.isGroup, f.syntax)),
                        (h = {}),
                        f.oneofs &&
                          Object.keys(f.oneofs).forEach(function (a) {
                            g.addChild((h[a] = new c.Message.OneOf(this, g, a)))
                          }, this),
                        f.fields &&
                          f.fields.forEach(function (a) {
                        ...
                        (i = []),
                        f.enums &&
                          f.enums.forEach(function (a) {
                            i.push(a)
                          }),
                        f.messages &&
                          f.messages.forEach(function (a) {
                            i.push(a)
                          }),
                        f.services &&
                          f.services.forEach(function (a) {
                            i.push(a)
                          }),
                ...
                if (b.imports && b.imports.length > 0) {
                  for (
                    ...
                    if ('string' == typeof b.imports[j]) {
                      ...
                      if ((/\.proto$/i.test(k) && !a.DotProto && (k = k.replace(/\.proto$/, '.json')), (l = a.Util.fetch(k)), null === l))
                      ...
                      c
                        ? /\.(\w+)$/.test(c)
                          ...
                          : this['import'](b.imports[j], c + '_import' + j)
                        : this['import'](b.imports[j])
              ...
              (e.resolveAll = function () {
                ...
                if (this.ptr instanceof c.Namespace)
                  ...
                  if (b.TYPE.test(this.ptr.type)) this.ptr.type = a.TYPES[this.ptr.type]
                    ...
                    if (((d = (this.ptr instanceof c.Message.ExtensionField ? this.ptr.extension.parent : this.ptr.parent).resolve(this.ptr.type, !0)), !d))
                    ...
                    if (((this.ptr.resolvedType = d), d instanceof c.Enum)) {
                      if (((this.ptr.type = a.TYPES['enum']), 'proto3' === this.ptr.syntax && 'proto3' !== d.syntax))
                  ...
                  if (((d = this.ptr.parent.resolve(this.ptr.requestName, !0)), !(d && d instanceof a.Reflect.Message)))
                    throw Error('Illegal type reference in ' + this.ptr.toString(!0) + ': ' + this.ptr.requestName)
                  if (((this.ptr.resolvedRequestType = d), (d = this.ptr.parent.resolve(this.ptr.responseName, !0)), !(d && d instanceof a.Reflect.Message)))
                    throw Error('Illegal type reference in ' + this.ptr.toString(!0) + ': ' + this.ptr.responseName)
                  this.ptr.resolvedResponseType = d
                } else if (
                  !(this.ptr instanceof a.Reflect.Message.OneOf || this.ptr instanceof a.Reflect.Extension || this.ptr instanceof a.Reflect.Enum.Value)
                )
          ...
          (e.Map = (function (a, b) {
            ...
            var c = function (a, c) {
                ...
                if (
                  ...
                  for (d = Object.keys(c), e = 0; e < d.length; e++)
          ...
          (e.loadProto = function (a, b, c) {
            return (
              ('string' == typeof b || (b && 'string' == typeof b.file && 'string' == typeof b.root)) && ((c = b), (b = void 0)),
              e.loadJson(e.DotProto.Parser.parse(a), b, c)
            )
          }),
          (e.protoFromString = e.loadProto),
          (e.loadProtoFile = function (a, b, c) {
            if ((b && 'object' == typeof b ? ((c = b), (b = null)) : (b && 'function' == typeof b) || (b = null), b))
              return e.Util.fetch('string' == typeof a ? a : a.root + '/' + a.file, function (d) {
                if (null === d) return b(Error('Failed to fetch file')), void 0
                try {
            ...
            var d = e.Util.fetch('object' == typeof a ? a.root + '/' + a.file : a)
            return null === d ? null : e.loadProto(d, c, a)
          }),
          (e.protoFromFile = e.loadProtoFile),
          (e.newBuilder = function (a) {
            return (
              (a = a || {}),
              'undefined' == typeof a.convertFieldsToCamelCase && (a.convertFieldsToCamelCase = e.convertFieldsToCamelCase),
              'undefined' == typeof a.populateAccessors && (a.populateAccessors = e.populateAccessors),
              new e.Builder(a)
            )
          }),
          (e.loadJson = function (a, b, c) {
            return (
              ('string' == typeof b || (b && 'string' == typeof b.file && 'string' == typeof b.root)) && ((c = b), (b = null)),
              (b && 'object' == typeof b) || (b = e.newBuilder()),
          ...
          (e.loadJsonFile = function (a, b, c) {
            ...
            var d = e.Util.fetch('object' == typeof a ? a.root + '/' + a.file : a)
            return null === d ? null : e.loadJson(JSON.parse(d), c, a)
          }),
          (h = a),
          (i = e.loadProto(h, void 0, '').build('Modules').probuf)
        )
      })(d, c, b)
    return e
  }
  ...
  var SSMsg$1 =
    ...
    FILE_TYPE.FILE +
    ';\n  }\n  message ' +
    PBName.GetQNupTokenInput +
    ' {\n    required FileType type = 1;\n    optional string key = 2;\n  }\n  message ' +
    PBName.GetQNdownloadUrlInput +
    ' {\n    required FileType type = 1;\n    required string key = 2;\n    optional string  fileName = 3;\n  }\n  message ' +
    PBName.GetQNupTokenOutput +
    ' {\n    required int64 deadline = 1;\n    required string token = 2;\n    optional string bosToken = 3;\n    optional string bosDate = 4;\n    optional string path = 5;\n  }\n  message ' +
    PBName.GetQNdownloadUrlOutput +
    ' {\n    required string downloadUrl = 1;\n  }\n  message Add2BlackListInput {\n    required string userId = 1;\n  }\n  message RemoveFromBlackListInput {\n    required string userId = 1;\n  }\n  message QueryBlackListInput {\n    required int32 nothing = 1;\n  }\n  message QueryBlackListOutput {\n    repeated string userIds = 1;\n  }\n  message BlackListStatusInput {\n    required string userId = 1;\n  }\n  message BlockPushInput {\n    required string blockeeId = 1;\n  }\n  message ModifyPermissionInput {\n    required int32 openStatus = 1;\n  }\n  message GroupInput {\n    repeated GroupInfo groupInfo = 1;\n  }\n  message GroupOutput {\n    required int32 nothing = 1;\n  }\n  message GroupInfo {\n    required string id = 1;\n    required string name = 2;\n  }\n  message GroupHashInput {\n    required string userId = 1;\n    required string groupHashCode = 2;\n  }\n  message GroupHashOutput {\n    required GroupHashType result = 1;\n  }\n  enum GroupHashType {\n    group_success = 0x00;\n    group_failure = 0x01;\n  }\n  message ' +
    PBName.ChrmInput +
    ' {\n    required int32 nothing = 1;\n  }\n  message ChrmOutput {\n    required int32 nothing = 1;\n  }\n  message ' +
    PBName.ChrmPullMsg +
    ' {\n    required int64 syncTime = 1;\n    required int32 count = 2;\n  }\n  \n  message ChrmPullMsgNew \n  {\n    required int32 count = 1;\n    required int64 syncTime = 2;\n    optional string chrmId=3;\n  }\n  message ' +
    PBName.RelationQryInput +
    '\n  {\n    optional ChannelType type = 1;\n    optional int32 count = 2;\n    optional int64 startTime = 3;\n    optional int32 order = 4;\n  }\n  message ' +
    PBName.RelationsInput +
    '\n  {\n    required ChannelType type = 1;\n    optional DownStreamMessage msg =2;\n    optional int32 count = 3;\n    optional int32 offset = 4;\n    optional int64 startTime = 5;\n    optional int64 endTime = 6;\n  }\n  message ' +
    PBName.RelationsOutput +
    '\n  {\n    repeated RelationInfo info = 1;\n  }\n  message RelationInfo\n  {\n    required ChannelType type = 1;\n    required string userId = 2;\n    optional DownStreamMessage msg =3;\n    optional int64 readMsgTime= 4;\n    optional int64 unreadCount= 5;\n  }\n  message RelationInfoReadTime\n  {\n    required ChannelType type = 1;\n    required int64 readMsgTime= 2;\n    required string targetId = 3;\n  }\n  message ' +
    PBName.CleanHisMsgInput +
    '\n  {\n      required string targetId = 1;\n      required int64 dataTime = 2;\n      optional int32 conversationType= 3;\n  }\n  message HistoryMessageInput\n  {\n    required string targetId = 1;\n    required int64 dataTime =2;\n    required int32 size  = 3;\n  }\n\n  message HistoryMessagesOuput\n  {\n    repeated DownStreamMessage list = 1;\n    required int64 syncTime = 2;\n    required int32 hasMsg = 3;\n  }\n  message ' +
    PBName.QueryChatRoomInfoInput +
    '\n  {\n    required int32 count= 1;\n    optional int32 order= 2;\n  }\n\n  message ' +
    PBName.QueryChatRoomInfoOutput +
    '\n  {\n    optional int32 userTotalNums = 1;\n    repeated ChrmMember userInfos = 2;\n  }\n  message ChrmMember\n  {\n    required int64 time = 1;\n    required string id = 2;\n  }\n  message MPFollowInput\n  {\n    required string id = 1;\n  }\n\n  message MPFollowOutput\n  {\n    required int32 nothing = 1;\n    optional MpInfo info =2;\n  }\n\n  message ' +
    PBName.MCFollowInput +
    '\n  {\n    required string id = 1;\n  }\n\n  message MCFollowOutput\n  {\n    required int32 nothing = 1;\n    optional MpInfo info =2;\n  }\n\n  message MpInfo  \n  {\n    required string mpid=1;\n    required string name = 2;\n    required string type = 3;\n    required int64 time=4;\n    optional string portraitUrl=5;\n    optional string extra =6;\n  }\n\n  message SearchMpInput\n  {\n    required int32 type=1;\n    required string id=2;\n  }\n\n  message SearchMpOutput\n  {\n    required int32 nothing=1;\n    repeated MpInfo info = 2;\n  }\n\n  message PullMpInput\n  {\n    required int64 time=1;\n    required string mpid=2;\n  }\n\n  message PullMpOutput\n  {\n    required int32 status=1;\n    repeated MpInfo info = 2;\n  }\n  message ' +
    PBName.HistoryMsgInput +
    '\n  {\n    optional string targetId = 1;\n    optional int64 time = 2;\n    optional int32 count  = 3;\n    optional int32 order = 4;\n  }\n\n  message ' +
    PBName.HistoryMsgOuput +
    '\n  {\n    repeated DownStreamMessage list=1;\n    required int64 syncTime=2;\n    required int32 hasMsg=3;\n  }\n  message ' +
    PBName.RtcQueryListInput +
    '{\n    optional int32 order=1;\n  }\n\n  message ' +
    PBName.RtcKeyDeleteInput +
    '{\n    repeated string key=1;\n  }\n\n  message ' +
    PBName.RtcValueInfo +
    '{\n    required string key=1;\n    required string value=2;\n  }\n\n  message RtcUserInfo{\n    required string userId=1;\n    repeated ' +
    PBName.RtcValueInfo +
    ' userData=2;\n  }\n\n  message ' +
    PBName.RtcUserListOutput +
    ...
    PBName.RtcSetDataInput +
    '{\n    required bool interior=1;\n    required targetType target=2;\n    required string key=3;\n    required string value=4;\n    optional string objectName=5;\n    optional string content=6;\n  }\n  message ' +
    PBName.RtcUserSetDataInput +
    ' {\n    repeated ' +
    PBName.RtcValueInfo +
    ' valueInfo = 1;\n    required string objectName = 2;\n    repeated ' +
    PBName.RtcValueInfo +
    ' content = 3;\n  }\n  message RtcOutput\n  {\n    optional int32 nothing=1; \n  }\n  message ' +
    PBName.RtcTokenOutput +
    '{\n    required string rtcToken=1;\n  }\n  enum targetType {\n    ROOM =1 ;\n    PERSON = 2;\n  }\n  message ' +
    PBName.RtcSetOutDataInput +
    '{\n    required targetType target=1;\n    repeated ' +
    PBName.RtcValueInfo +
    ' valueInfo=2;\n    optional string objectName=3;\n    optional string content=4;\n  }\n  message ' +
    PBName.RtcQryUserOutDataInput +
    '{\n    repeated string userId = 1;\n  }\n  message ' +
    PBName.RtcUserOutDataOutput +
    '{\n    repeated RtcUserInfo user = 1;\n  }\n  message ' +
    PBName.SessionsAttQryInput +
    '{\n    required int32 nothing = 1;\n  }\n  message ' +
    PBName.SessionsAttOutput +
    '{\n    required int64 inboxTime = 1;\n    required int64 sendboxTime = 2;\n    required int64 totalUnreadCount = 3;\n  }\n  message ' +
    PBName.SessionMsgReadInput +
    '\n  {\n    required ChannelType type = 1;\n    required int64 msgTime = 2;\n    required string channelId = 3;\n  }\n  message SessionMsgReadOutput\n  {\n    optional int32 nothing=1; \n  }\n  message ' +
    PBName.DeleteSessionsInput +
    '\n  {\n    repeated SessionInfo sessions = 1;\n  }\n  message ' +
    PBName.SessionInfo +
    '\n  {\n    required ChannelType type = 1;\n    required string channelId = 2;\n  }\n  message ' +
    PBName.DeleteSessionsOutput +
    '\n  {\n    optional int32 nothing=1; \n  }\n  message ' +
    PBName.DeleteMsgInput +
    ...
    PBName.ChrmNotifyMsg +
    ' {\t\n    required int32 type= 1;\n    optional int64 time= 2;\n    optional string chrmId=3;\n  }\n  message ' +
    PBName.SetUserSettingInput +
    ' {\n    required int64 version=1;\n    required string value=2;\n  }\n  message ' +
    PBName.SetUserSettingOutput +
    ' {\n    required int64 version=1;\n    required bool reserve=2;\n  }\n  message ' +
    PBName.PullUserSettingInput +
    ' {\n    required int64 version=1;//\u5F53\u524D\u5BA2\u6237\u7AEF\u7684\u6700\u5927\u7248\u672C\u53F7\n    optional bool reserve=2;\n  }\n  message ' +
    PBName.PullUserSettingOutput +
    ' {\n    repeated UserSettingItem items = 1;\n    required int64 version=2;\n  }\n  message UserSettingItem {\n    required string targetId= 1;\n    required ChannelType type = 2;\n    required string key = 4;\n    required bytes value = 5;\n    required int64 version=6;\n    required int32 status=7;\n  }\n  message ' +
    PBName.SessionReq +
    ' {\n    required int64 time = 1;\n  }\n  message ' +
    PBName.SessionStates +
    ' {\n    required int64 version=1;\n    repeated SessionState state= 2;\n  }\n  message ' +
    PBName.SessionState +
    ' {\n    required ChannelType type = 1;\n    required string channelId = 2;  \n    optional int64 time = 3;\n    repeated SessionStateItem stateItem = 4;\n  }\n  message ' +
    PBName.SessionStateItem +
    ' {\n    required SessionStateType sessionStateType = 1;\n    required string value = 2;\n  }\n  enum SessionStateType {\n    IsSilent = 1;\n    IsTop = 2;\n  }\n  message ' +
    PBName.SessionStateModifyReq +
    ' {\n    required int64 version=1;\n    repeated SessionState state= 2;\n  }\n  message ' +
    PBName.SessionStateModifyResp +
    ' {\n    required int64 version=1;\n  }\n}\n'
  ...
  var Codec$2 = (function () {
    ...
    _proto.decodeByPBName = function decodeByPBName(data, pbName, option) {
      ...
      var formatEventMap =
        ((_formatEventMap = {}),
        (_formatEventMap[PBName.DownStreamMessages] = self.formatSyncMessages),
        (_formatEventMap[PBName.DownStreamMessage] = self.formatReceivedMessage),
        (_formatEventMap[PBName.UpStreamMessage] = self.formatSentMessage),
        (_formatEventMap[PBName.HistoryMsgOuput] = self.formatHistoryMessages),
        (_formatEventMap[PBName.RelationsOutput] = self.formatConversationList),
        (_formatEventMap[PBName.QueryChatRoomInfoOutput] = self.formatChatRoomInfos),
        (_formatEventMap[PBName.RtcUserListOutput] = self.formatRTCUserList),
        (_formatEventMap[PBName.RtcQryOutput] = self.formatRTCData),
        (_formatEventMap[PBName.ChrmKVOutput] = self.formatChatRoomKVList),
        (_formatEventMap[PBName.PullUserSettingOutput] = self.formatUserSetting),
        (_formatEventMap[PBName.SessionStates] = self.formatConversationStatus),
        _formatEventMap)
  ...
  var ServerEngine = (function () {
    ...
    _proto._dispatchTask = function _dispatchTask(signal) {
      ...
      if (signal instanceof PublishReader) {
        ...
        var task =
          ((_PUBLISH_TOPIC$NOTIFY = {}),
          (_PUBLISH_TOPIC$NOTIFY[PUBLISH_TOPIC.NOTIFY_PULL_MSG] = self._notifyPullMessage),
          (_PUBLISH_TOPIC$NOTIFY[PUBLISH_TOPIC.RECEIVE_MSG] = self._notifyDirectMessage),
          (_PUBLISH_TOPIC$NOTIFY[PUBLISH_TOPIC.SERVER_NOTIFY] = self._notifyForServer),
          (_PUBLISH_TOPIC$NOTIFY[PUBLISH_TOPIC.SETTING_NOTIFY] = self._notifySettingChanged),
          _PUBLISH_TOPIC$NOTIFY)[topic] || utils.noop
      ...
      return utils
        ...
        .then(function (signal) {
          ...
          if (isSuccess && decodePBName) {
            signal.data = _serverDataCodec.decodeByPBName(
              data,
              decodePBName,
              utils.extend(
                {
  ...
  var BASE_NAVI_RESP = {
    ...
    backupServer: '',
    voipCallInfo:
      '{"strategy":1,"callEngine":[{"engineType":4,"mediaServer":"https://rtc-info.ronghub.com","maxStreamCount":20},{"engineType":3,"vendorKey":"","signKey":"","blinkCMPServer":"rtccmp.ronghub.com:80","blinkSnifferServer":"rtccmp.ronghub.com:80"}]}',
    kvStorage: 1,
  ...
  var NaviManager = (function () {
    ...
    _proto2.get = function get() {
      ...
      return utils.requestByUrlList(urlList).then(
        function (_ref) {
          var responseText = _ref.responseText
          Logger.info(TAG.L_GET_NAVI_R, {
            content: {
          ...
          if (isSuccess) {
            ...
            return utils.Defer.reject(
              utils.extendInShallow(ERROR_INFO.NAVI_REQUEST_ERROR, {
                error: responseText
              })
            )
          }
  ...
  var STORAGE_KEY_MAP_CONVERSATION =
    ((_STORAGE_KEY_MAP_CONV = {}),
    (_STORAGE_KEY_MAP_CONV[SUB_KEY.UNREAD_COUNT] = {
  ...
  var ConversationStatusManager = (function () {
    function ConversationStatusManager(serverEngine) {
      ...
      serverEngine.watch(
        ((_serverEngine$watch = {}),
        (_serverEngine$watch[SERVER_EVENT_NAME.CONVERSATION_STATUS_CHANGED] = self._handleConversationStatusChanged),
        (_serverEngine$watch[SERVER_EVENT_NAME.CONVERSATION_STATUS_SETED] = self._handleSetConversationStatus),
        _serverEngine$watch)
      )
    ...
    _proto.close = function close() {
      ...
      this._serverEngine.unwatch(
        ((_this$_serverEngine$u = {}),
        (_this$_serverEngine$u[SERVER_EVENT_NAME.CONVERSATION_STATUS_CHANGED] = this._handleConversationStatusChanged),
        (_this$_serverEngine$u[SERVER_EVENT_NAME.CONVERSATION_STATUS_SETED] = this._handleSetConversationStatus),
        _this$_serverEngine$u)
      )
    }
  ...
  var ConversationManager = (function () {
    ...
    _proto._setMentiondInfo = function _setMentiondInfo(message, conversation) {
      ...
      if (isSelfSend);
      else if (isMentiond && hasContent && content.mentionedInfo) {
  ...
  var MessagePullManager = (function () {
    function MessagePullManager(serverEngine, option) {
      ...
      serverEngine.watch(
        ((_serverEngine$watch = {}),
        (_serverEngine$watch[SERVER_EVENT_NAME.DIRECT_MSG] = self._handleDirectMessage),
        (_serverEngine$watch[SERVER_EVENT_NAME.NOTIFY_PULL] = self._handleNotifyPull),
        (_serverEngine$watch[SERVER_EVENT_NAME.JOIN_CHATROOM] = self._handleJoinChatRoom),
        (_serverEngine$watch[SERVER_EVENT_NAME.MESSAGE_SEND] = self._handleSendMessage),
        _serverEngine$watch)
      )
      self._serverEngine = serverEngine
    ...
    _proto.close = function close() {
      ...
      this._serverEngine.unwatch(
        ((_this$_serverEngine$u = {}),
        (_this$_serverEngine$u[SERVER_EVENT_NAME.DIRECT_MSG] = this._handleDirectMessage),
        (_this$_serverEngine$u[SERVER_EVENT_NAME.NOTIFY_PULL] = this._handleNotifyPull),
        (_this$_serverEngine$u[SERVER_EVENT_NAME.JOIN_CHATROOM] = this._handleJoinChatRoom),
        (_this$_serverEngine$u[SERVER_EVENT_NAME.MESSAGE_SEND] = this._handleSendMessage),
        _this$_serverEngine$u)
      )
    }
  ...
  var ChatRoomKVManager = (function () {
    function ChatRoomKVManager(serverEngine) {
      ...
      serverEngine.watch(
        ((_serverEngine$watch = {}),
        (_serverEngine$watch[SERVER_EVENT_NAME.CHRM_KV_SET] = self._handleChrmKVSet),
        (_serverEngine$watch[SERVER_EVENT_NAME.CHRM_KV_CHANGED] = self._handleChrmKVChanged),
        (_serverEngine$watch[SERVER_EVENT_NAME.BEFORE_JOIN_CHATROOM] = self._handleBeforeJoinChrm),
        _serverEngine$watch)
      )
    ...
    _proto.close = function close() {
      ...
      self._serverEngine.unwatch(
        ((_self$_serverEngine$u = {}),
        (_self$_serverEngine$u[SERVER_EVENT_NAME.CHRM_KV_SET] = self._handleChrmKVSet),
        (_self$_serverEngine$u[SERVER_EVENT_NAME.CHRM_KV_CHANGED] = self._handleChrmKVChanged),
        (_self$_serverEngine$u[SERVER_EVENT_NAME.BEFORE_JOIN_CHATROOM] = self._handleBeforeJoinChrm),
        _self$_serverEngine$u)
      )
    }
  ...
  var SettingManager = (function () {
    function SettingManager(serverEngine, option) {
      ...
      self._serverEngine = serverEngine
      serverEngine.watch(
        ((_serverEngine$watch = {}), (_serverEngine$watch[SERVER_EVENT_NAME.USER_SETTING_CHANGED] = self._handleNotifySettingChanged), _serverEngine$watch)
      )
    ...
    _proto.close = function close() {
      ...
      this._serverEngine.unwatch(
        ((_this$_serverEngine$u = {}),
        (_this$_serverEngine$u[SERVER_EVENT_NAME.USER_SETTING_CHANGED] = this._handleNotifySettingChanged),
        _this$_serverEngine$u)
      )
    }
  ...
  var WebIMEngine = (function () {
    ...
    _proto.watch = function watch(watchers) {
      ...
      var events =
        ((_events = {}),
        (_events[IM_EVENT.STATUS] = statusWatcher),
        (_events[IM_EVENT.MESSAGE] = messageWatcher),
        (_events[IM_EVENT.CONVERSATION] = conversationWatcher),
        (_events[IM_EVENT.CHATROOM] = chatroomWatcher),
        _events)
      utils.forEach(events, function (event, eventName) {
    ...
    _proto.joinChatRoom = function joinChatRoom(chrm, option) {
      ...
      return _serverEngine
        ...
        .then(function (configForNavi) {
          ...
          !isAutoRejoin &&
            _joinedChatRoomSyner.set({
              chrmId: chrm.id,
              count: option.count,
              isOpenJoinMulitpleChrmService: isOpenJoinMulitpleChrmService
            })
          var initialTime = 0
          return isOpenKVStorageService
            ? _chatRoomKVManager.pull({
                time: initialTime,
                chrmId: chrm.id
              })
            : utils.Defer.resolve()
  ...
  var EngineDispatcher = (function () {
    ...
    _proto._exec = function _exec(params) {
      ...
      return utils.isPromise(execResult)
        ? execResult['catch'](function (error) {
  ...
  var MESSAGE_TYPE_VALIDATE =
    ((_MESSAGE_TYPE_VALIDAT = {}),
    (_MESSAGE_TYPE_VALIDAT[MESSAGE_TYPE.TEXT] = {
      content: Type.String
    }),
